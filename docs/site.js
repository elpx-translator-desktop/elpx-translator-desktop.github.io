...
const SITE_I18N = {
  es: {
    meta_description: 'Herramienta para traducir archivos .elpx en versión de escritorio y versión web.',
    ...
    hero_lead: 'ELPX Translator sirve para traducir proyectos de eXeLearning. Puedes elegir entre la versión de escritorio y la versión web.',
    hero_desktop_button_label: 'Versión de escritorio',
    hero_desktop_button_note: 'Traducción local o con tu propia API',
    hero_web_button_label: 'Versión web',
    hero_web_button_note: 'Traducción con tu propia API',
    ...
    hero_image_alt: 'Ventana principal de ELPX Translator',
    what_eyebrow: 'Qué es',
    ...
    downloads_body: 'La página consulta GitHub Releases y muestra la última versión estable disponible y, si existe, la beta más reciente. En Linux verás tanto el paquete <code>.deb</code> como la <code>AppImage</code>.',
    ...
    screenshot_2_alt: 'Ventana de configuración de la aplicación',
    screenshot_2_caption: 'La configuración permite elegir el modo de traducción, el idioma de la interfaz y los ajustes del modo API.',
    ...
    footer_body: 'ELPX Translator es un proyecto independiente para traducir archivos <code>.elpx</code>.',
  ...
  en: {
    meta_description: 'Tool for translating .elpx files in desktop and web versions.',
    ...
    hero_lead: 'ELPX Translator helps translate eXeLearning projects. You can choose between the desktop version and the web version.',
    hero_desktop_button_label: 'Desktop version',
    hero_desktop_button_note: 'Local translation or with your own API',
    hero_web_button_label: 'Web version',
    hero_web_button_note: 'Translation with your own API',
    ...
    hero_image_alt: 'Main window of ELPX Translator',
    ...
    downloads_body: 'This page checks GitHub Releases and shows the latest stable release available and, when it exists, the most recent beta. On Linux you will see both the <code>.deb</code> package and the <code>AppImage</code>.',
    ...
    screenshot_2_alt: 'Application settings window',
    screenshot_2_caption: 'Settings let you choose the translation mode, the interface language, and the API mode options.',
    ...
    footer_body: 'ELPX Translator is an independent project for translating <code>.elpx</code> files.',
  ...
  ca: {
    meta_description: 'Eina per traduir fitxers .elpx amb versió d’escriptori i versió web.',
    language_label: 'Idioma',
    ...
    hero_lead: 'ELPX Translator serveix per traduir projectes d’eXeLearning. Pots triar entre la versió d’escriptori i la versió web.',
    hero_desktop_button_label: 'Versió d’escriptori',
    hero_desktop_button_note: 'Traducció local o amb la teua API',
    hero_web_button_label: 'Versió web',
    hero_web_button_note: 'Traducció amb la teua API',
    ...
    hero_image_alt: 'Finestra principal d’ELPX Translator',
    what_eyebrow: 'Què és',
    ...
    downloads_body: 'La pàgina consulta GitHub Releases i mostra l’última versió estable disponible i, si existeix, la beta més recent. A Linux hi veuràs tant el paquet <code>.deb</code> com l’<code>AppImage</code>.',
    ...
    screenshot_2_alt: 'Finestra de configuració de l’aplicació',
    screenshot_2_caption: 'La configuració permet triar el mode de traducció, l’idioma de la interfície i les opcions del mode API.',
    ...
    footer_body: 'ELPX Translator és un projecte independent per traduir fitxers <code>.elpx</code>.',
  ...
  eu: {
    ...
    hero_lead: 'ELPX Translator-ek eXeLearning proiektuak itzultzen laguntzen du. Mahaigaineko bertsioaren eta web bertsioaren artean aukera dezakezu.',
    hero_desktop_button_label: 'Mahaigaineko bertsioa',
    hero_desktop_button_note: 'Itzulpena lokalean edo zure APIarekin',
    hero_web_button_label: 'Web bertsioa',
    hero_web_button_note: 'Itzulpena zure APIarekin',
    ...
    hero_image_alt: 'ELPX Translator-en leiho nagusia',
    ...
    downloads_body: 'Orri honek GitHub Releases kontsultatzen du eta eskuragarri dagoen azken bertsio egonkorra erakusten du, eta badagoenean, azken beta ere bai. Linuxen <code>.deb</code> paketea eta <code>AppImage</code>a ikusiko dituzu.',
    ...
    screenshot_2_alt: 'Aplikazioaren ezarpenen leihoa',
    screenshot_2_caption: 'Ezarpenetan itzulpen modua, interfazearen hizkuntza eta API moduko aukerak hauta daitezke.',
    ...
    footer_body: 'ELPX Translator proiektu independentea da <code>.elpx</code> fitxategiak itzultzeko.',
  ...
  gl: {
    ...
    hero_lead: 'ELPX Translator serve para traducir proxectos de eXeLearning. Podes escoller entre a versión de escritorio e a versión web.',
    hero_desktop_button_label: 'Versión de escritorio',
    hero_desktop_button_note: 'Tradución local ou coa túa propia API',
    hero_web_button_label: 'Versión web',
    hero_web_button_note: 'Tradución coa túa propia API',
    hero_cta_downloads: 'Ver descargas',
    ...
    hero_image_alt: 'Xanela principal de ELPX Translator',
    what_eyebrow: 'Que é',
    ...
    downloads_body: 'A páxina consulta GitHub Releases e mostra a última versión estable dispoñible e, se existe, a beta máis recente. En Linux verás tanto o paquete <code>.deb</code> como a <code>AppImage</code>.',
    ...
    screenshot_2_alt: 'Xanela de configuración da aplicación',
    screenshot_2_caption: 'A configuración permite escoller o modo de tradución, o idioma da interface e as opcións do modo API.',
    ...
    footer_body: 'ELPX Translator é un proxecto independente para traducir ficheiros <code>.elpx</code>.',
    footer_author: 'Creado por <strong>Juan José de Haro</strong>.',
...
function applyStaticTranslations(language) {
  ...
  document.title = 'ELPX Translator';
